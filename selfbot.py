...
async def on_message(message):
    ...
    if message.content.startswith('-lo') and message.channel.id == data.command_channel:
    ...
    if data.game_in_session and message.channel.id in data.input_loco_private:
    ...
    if data.game_in_session and message.channel.id in data.input_loco_public:
        if message.content == '1' or message.content == '1apg' or message.content == '1 apg':
