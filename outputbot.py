...
def update_embed():
    ...
    if data.embed is None:
        data.embed = discord.Embed(title='**__LOCO TRIVIA__**', color=0x89cff0)
        ...
        data.embed.set_footer(text= 'Created by Prashant',icon_url='https://cdn.discordapp.com/attachments/597175122222252038/599249343337332749/JPEG_20190612_142227.jpg')

        data.embed_best = discord.Embed(title='**__LOCO TRIVIA__**', color=0x89cff0)
